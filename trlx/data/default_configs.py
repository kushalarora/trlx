...
from trlx.models.modeling_ppo_multi import PPOMultiConfig
...
def default_mpror_config():
    return TRLConfig(
        train=TrainConfig(
            ...
            eval_interval=100,
            pipeline="MPRORPipeline",
            trainer="AccelerateMPRORTrainer",
        ),
...
def default_ppo_multi_config():
    return TRLConfig(
        train=TrainConfig(
            ...
            checkpoint_interval=10000,
            eval_interval=100,
            pipeline="PPOMultiPipeline",
            trainer="AcceleratePPOMultiTrainer",
        ),
        model=ModelConfig(model_path="lvwerra/gpt2-imdb", num_layers_unfrozen=2),
        tokenizer=TokenizerConfig(tokenizer_path="gpt2", truncation_side="right"),
        optimizer=OptimizerConfig(
